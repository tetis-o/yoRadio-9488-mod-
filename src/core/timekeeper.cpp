  ...
  weatherClient->onConnect([](void * arg, AsyncClient * client){
    ...
    client->onData([](void * arg, AsyncClient * c, void * data, size_t len){
      ...
      if (bodyStart != NULL) {
        ...
        /* parse it */
        char *cursor;
        char desc[120], icon[5], station[64];
        ...
        sprintf(timekeeper.weatherBuf, weatherFmt, station, tempf, press, hum);
          ...
          #else
            sprintf(timekeeper.weatherBuf, LANG::weatherFmt,  tempf, press, LANG::wind[(int)(wind_deg/22.5)], wind_speed);
          #endif
        #endif
...
void TimeKeeper::PrintIcon() {  
  dsp.fillRect(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, 110,64, 0x0000);
  if (!display.ready()) return;
  if (!config.store.showweather) {
    dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, logo, 99, 64);
    return;
  }
  // choose bitmap by last parsed icon stored in timekeeper.weatherIcon
  if(strstr(timekeeper.weatherIcon, "01d") != NULL)      dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_01d, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "01n") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_01n, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "02d") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_02d, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "02n") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_02n, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "03d") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_03d, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "03n") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_03n, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "04d") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_04d, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "04n") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_04n, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "09d") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_09d, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "09n") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_09n, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "10d") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_10d, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "10n") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_10n, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "11d") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_11d, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "11n") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_11n, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "13d") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_13d, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "13n") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_13n, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "50d") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_50d, 110, 64);
  else if(strstr(timekeeper.weatherIcon, "50n") != NULL) dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, img_50n, 110, 64);
  else dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, weather4, 110, 64);
 ...
 dsp.fillRect(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, 110,64, 0x0000);
  ...
  return;
     ...
     dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, weather4, 110, 64);
     //dsp.drawRGBBitmap(ICON_WEATHER_LEFT, ICON_WEATHER_TOP, logo, 99, 64);
 }
//******************
