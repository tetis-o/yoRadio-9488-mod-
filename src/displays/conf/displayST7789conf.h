...
const ScrollConfig metaConf       PROGMEM = {{ TFT_FRAMEWDT, 4, 2, WA_CENTER }, 140, true, MAX_WIDTH, 5000, 5, 30 };
const ScrollConfig title1Conf     PROGMEM = {{ TFT_FRAMEWDT, 28, 2, WA_CENTER }, 140, true, MAX_WIDTH, 5000, 4, 30 };
const ScrollConfig title2Conf     PROGMEM = {{ TFT_FRAMEWDT, 48, 2, WA_CENTER }, 140, false, MAX_WIDTH, 5000, 4, 30 };
...
const ScrollConfig weatherConf    PROGMEM = {{ 8, 74, 2, WA_LEFT }, 140, false, MAX_WIDTH, 0, 4, 30 };
...
const WidgetConfig voltxtConf     PROGMEM = { 0, 214-6, 2, WA_CENTER };
const WidgetConfig  iptxtConf     PROGMEM = { TFT_FRAMEWDT, 214, 1, WA_LEFT };
const WidgetConfig   rssiConf     PROGMEM = { TFT_FRAMEWDT, 210, 2, WA_RIGHT };
...
const WidgetConfig  clockConf     PROGMEM = { 8, 150, 0, WA_RIGHT };
const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 182, 1, WA_LEFT };

const WidgetConfig bootWdtConf    PROGMEM = { 0, 162, 1, WA_CENTER };
const ProgressConfig bootPrgConf  PROGMEM = { 90, 14, 4 };
const BitrateConfig fullbitrateConf PROGMEM = {{TFT_FRAMEWDT, 154, 2, WA_LEFT}, 46 };

/* BANDS  */                             /* { onebandwidth, onebandheight, bandsHspace, bandsVspace, numofbands, fadespeed } */
const VUBandsConfig bandsConf     PROGMEM = { 286, 9, 3, 1, 13, 5 };

/* STRINGS  */
const char         numtxtFmt[]    PROGMEM = "%d";
//const char           rssiFmt[]    PROGMEM = "WiFi %d";
const char           rssiFmt[]    PROGMEM = "\027%d dBm";
...
const MoveConfig   weatherMove    PROGMEM = { 8, 74, MAX_WIDTH };
const MoveConfig   weatherMoveVU  PROGMEM = { 8, 74, MAX_WIDTH};
