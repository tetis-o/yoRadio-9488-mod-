...
const ScrollConfig title2Conf     PROGMEM = {{ TFT_FRAMEWDT, 56, 2, WA_CENTER }, 140, false, MAX_WIDTH, 5000, 4, 30 };
...
const ScrollConfig weatherConf    PROGMEM = {{ 8, 76, 2, WA_LEFT }, 140, false, MAX_WIDTH, 0, 4, 30 };
...
const FillConfig  heapbarConf     PROGMEM = {{ 0, 236, 0, WA_LEFT }, DSP_WIDTH, 2, false };
...
const WidgetConfig  clockConf     PROGMEM = { TFT_FRAMEWDT, 152, 0, WA_RIGHT };
...
const BitrateConfig fullbitrateConf PROGMEM = {{TFT_FRAMEWDT-4, 154, 2, WA_LEFT}, 48 };

/* BANDS  */                             /* { onebandwidth, onebandheight, bandsHspace, bandsVspace, numofbands, fadespeed } */
const VUBandsConfig bandsConf     PROGMEM = { 300, 10, 4, 2, 15, 2 };
...
const MoveConfig   weatherMove    PROGMEM = { 4, 76, MAX_WIDTH };
const MoveConfig   weatherMoveVU  PROGMEM = { 4, 76, MAX_WIDTH };
